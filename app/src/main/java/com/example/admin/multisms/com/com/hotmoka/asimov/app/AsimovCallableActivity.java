...
/**
 * An activity that can be called with an explicit parameter.
 * 
 * @author Fausto Spoto <fausto.spoto@hotmoka.com>
 */

public abstract class AsimovCallableActivity<Param> extends AsimovActivity implements AsimovCallableActivityInterface<Param> {
